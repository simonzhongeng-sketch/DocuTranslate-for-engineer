        ...
        <div class="p-3 bg-white dark:bg-gray-800">
            <div class="flex flex-col gap-3">
                ...
                <div v-if="shouldShowStatistics" class="stats-section">
                    <div v-if="currentStats.dxf" class="dxf-stats-grid mb-2">
                        <div class="stat-item">
                            <span class="stat-label">DXF Text</span>
                            <span class="stat-value">{{ currentStats.dxf.total_entities || 0 }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-label">Filtered</span>
                            <span class="stat-value">{{ currentStats.dxf.filtered_count || 0 }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-label">Valid</span>
                            <span class="stat-value">{{ currentStats.dxf.valid_text_count || 0 }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-label">Unique</span>
                            <span class="stat-value">{{ currentStats.dxf.unique_text_count || 0 }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-label">Written</span>
                            <span class="stat-value">{{ currentStats.dxf.writeback_success_count || 0 }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-label">Failed</span>
                            <span class="stat-value stat-value-error error-red">{{ (currentStats.dxf.translate_failed_count || 0) + (currentStats.dxf.writeback_failed_count || 0) }}</span>
                        </div>
                    </div>
...
[data-theme="dark"] .dxf-stats-grid {
