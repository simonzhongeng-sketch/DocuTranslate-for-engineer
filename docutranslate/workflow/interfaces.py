...
@runtime_checkable
class DxfExportable(Protocol[T_ExporterConfig]):
    def export_to_dxf(self, config: T_ExporterConfig | None = None) -> bytes:
        ...

    def save_as_dxf(self, name: str, output_dir: Path | str, config: T_ExporterConfig | None = None) -> Self:
        ...
